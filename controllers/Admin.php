...
use App\Core\Http\Controller\AdminController;
...
class Admin extends AdminController {
    ...
    public function index() {
        $providers = $this->config->item('providers', 'social');

        // Build an array of what is available
        foreach ($providers as $name => $provider) {
            $providers[$name]['human'] = $this->providers[$name]['human'];
            $providers[$name]['default_scope'] = element('default_scope', $this->providers[$name], NULL);
        }
        ...
        $this->template
                ...
                ->build('admin/index', compact('providers'));
    }
